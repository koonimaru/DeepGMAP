...
#this code design came from https://gist.github.com/danijar/8663d3bbfd586bffecf6a0094cd116f2
...
class Model(object):
    ...
    def optimize(self):
        with tf.device('/device:GPU:'+self.GPUID):
            optimizer = tf.train.AdamOptimizer(learning_rate=self.train_speed)
