...
file_list=glob.glob('/media/koh/HD-PCFU3/mouse/various_dnase_data/bedfiles/testfiles/*.bed')
...
sp.check_call(["bedtools", "intersect","-u", "-a", str(file_list[0]), "-b", str(file_list[1])], stdout=ABout)
ABout.close()
...
sp.check_call(["bedtools", "intersect","-u", "-a", str(file_list[1]), "-b", str(file_list[0])], stdout=ABout_)
ABout_.close()
...
sp.check_call(["bedtools", "intersect","-u", "-a", str(file_list[0]), "-b", str(file_list[2])], stdout=ACout)
ACout.close()
...
sp.check_call(["bedtools", "intersect","-u", "-a", str(file_list[2]), "-b", str(file_list[0])], stdout=ACout_)
ACout_.close()
...
sp.check_call(["bedtools", "intersect","-u", "-a", str(file_list[2]), "-b", str(file_list[1])], stdout=BCout)
BCout.close()
...
sp.check_call(["bedtools", "intersect","-u", "-a", str(file_list[1]), "-b", str(file_list[2])], stdout=BCout_)
BCout_.close()
...
sp.check_call(["bedtools", "intersect","-u", "-a", 'intersectAB.bed', "-b", str(file_list[2])],stdout=ABCout)
ABCout.close()
...
sp.check_call(["bedtools", "intersect","-u", "-b", 'intersectAB.bed', "-a", str(file_list[2])],stdout=ABCout_)
ABCout_.close()
